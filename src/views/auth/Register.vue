        ...
        <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
            ...
            <form action="#">
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="password_confirm" class="text-gray-600 mb-2 block">Confirm Password</label>
                        <input type="password" id="password_confirm" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-primary placeholder-gray-400" placeholder="Enter your password">
                    </div>
                    <div>
                        <label for="password" class="text-gray-600 mb-2 block">Password</label>
                        <input type="password" id="password" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-primary placeholder-gray-400" placeholder="Confirm your password">
                    </div>
                </div>
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        <input type="checkbox" name="" id="agreement" class="text-primary  focus:ring-0 rounded-sm cursor-pointer">
                        <label for="agreement" class="text-gray-600 ml-3 cursor-pointer">I have read and agree to the <span class="text-primary">terms and conditions</span></label>
                    </div>
                </div>
                <div class="mt-4">
            ...
            <div class="mt-6 flex justify-center relative">
                <div class="text-gray-600 uppercase px-3 bg-white z-10 relative">Or Signup in with</div>
            ...
            <p class="mt-4 text-gray-600 text-center">
                Already have an account? <a href="#" class="text-primary">Login now</a>
            </p>
        </div>
    </div>
    <!-- Register end -->
