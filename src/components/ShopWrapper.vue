    ...
    <!-- shop wrapper -->
        <div class="container grid grid-cols-4 gap-6 pt-4 pb-16 items-start">
                ...
                <div class="divide-y divide-gray-200 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" checked id="Bedroom" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                    ...
                    <div class="pt-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <!-- single brand name -->
                            <div class="flex items-center">
                                <input type="checkbox" checked id="Karl" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                    ...
                    <div class="pt-4">
                        ...
                        <div class="mt-4 flex items-center">
                            <input type="text" class="w-full border-gray-300 focus:border-primary focus:ring-0 px-3 py-1 text-gray-600 text-sm shadow rounded" placeholder="min">
                            <span class="mx-3 text-gray-500">-</span>
                            <input type="text" class="w-full border-gray-300 focus:border-primary focus:ring-0 px-3 py-1 text-gray-600 text-sm shadow rounded" placeholder="max">
                        </div>
                    </div>
                    <!-- price filter end -->
                    ...
                    <div class="pt-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div class="size-selector">
                                ...
                                <label for="size-xs" class="text-xs border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-500">
                                    XS
                                </label>
                            </div>
                            <!-- single size end -->
                            ...
                            <div class="size-selector">
                                ...
                                <label for="size-s" class="text-xs border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-500">
                                    S
                                </label>
                            </div>
                            <!-- single size end -->
                            ...
                            <div class="size-selector">
                                ...
                                <label for="size-m" class="text-xs border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-500">
                                    M
                                </label>
                            </div>
                            <!-- single size end -->
                            ...
                            <div class="size-selector">
                                ...
                                <label for="size-l" class="text-xs border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-500">
                                    L
                                </label>
                            </div>
                            <!-- single size end -->
                    ...
                    <div class="pt-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div class="color-selector">
                                ...
                                <label for="color-red" class="border border-gray-200 rounded-sm h-5 w-5 cursor-pointer shadow-sm block" style="background-color: #fc3d57;">
                                </label>
                            </div>
                            <!-- single color end -->
                            <!-- single color -->
                            <div class="color-selector">
                                ...
                                <label for="color-white" class="border border-gray-200 rounded-sm h-5 w-5 cursor-pointer shadow-sm block" style="background-color: #fff;">
                                </label>
                            </div>
                            <!-- single color end -->
                            <!-- single color -->
                            <div class="color-selector">
                                ...
                                <label for="color-black" class="border border-gray-200 rounded-sm h-5 w-5 cursor-pointer shadow-sm block" style="background-color: #000;">
                                </label>
                            </div>
                            <!-- single color end -->
                        </div>
            ...
            <div class="col-span-3">
                ...
                <div class="flex items-center mb-4">
                    <select class="w-44 text-sm text-gray-600 px-5 py-3 border-gray-300 shadow-sm rounded focus:ring-primary focus:border-primary">
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <!-- product image -->
                <div class="relative">
                    <img src="../assets/images/products/chair.jpg" alt="chair" class="w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-700 transition">
                ...
                <div class="pt-4 pb-3 px-4">
                    ...
                    <div class="flex items-baseline mb-1 space-x-2 font-roboto">
                        ...
                        <p class="text-sm text-gray-600 line-through">$55.00</p>
                    </div>
                    <div class="flex items-center">
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <!-- product image -->
                <div class="relative">
                    <img src="../assets/images/products/chair2.jpg" alt="chair" class="w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-700 transition">
                            <i class="fas fa-search"></i>
                        </a>
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <!-- product image -->
                <div class="relative">
                    <img src="../assets/images/products/chair3.jpg" alt="chair" class="w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-700 transition">
                            <i class="fas fa-search"></i>
                        </a>
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <!-- product image -->
                <div class="relative">
                    <img src="../assets/images/products/chair12.jpg" alt="chair" class="w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-700 transition">
                            <i class="fas fa-search"></i>
                        </a>
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <!-- product image -->
                <div class="relative">
                    <img src="../assets/images/products/chair9.jpg" alt="chair" class="w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-700 transition">
                            <i class="fas fa-search"></i>
                        </a>
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <!-- product image -->
                <div class="relative">
                    <img src="../assets/images/products/chair10.jpg" alt="chair" class="w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-700 transition">
                            <i class="fas fa-search"></i>
                        </a>
